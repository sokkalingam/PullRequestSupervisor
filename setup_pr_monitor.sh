...
echo "rake ${name}:user > logs/${name}_user.log" >> run_scripts/run_${name}_user.sh 

sed '$d' run_scripts/run_monitor_pr.sh > run_scripts/run_${name}_pr.sh
echo "rake ${name}:pr > logs/${name}_pr.log" >> run_scripts/run_${name}_pr.sh

sed '$d' run_scripts/run_monitor_email.sh > run_scripts/run_${name}_email.sh
echo "rake ${name}:email > logs/${name}_email.log" >> run_scripts/run_${name}_email.sh
